...
const AudioEmptyRow = () => {
    ...
    return (
        <div className="AudioItemRow__row" style={{padding: "10px"}}>

            <div className="AudioItemRow__row__visible cursor_pointer" onClick={() => {
                changeSort(1)
            }}>
            ...
            <div className="AudioItemRow__row__id cursor_pointer" onClick={() => {
                changeSort(3)
            }}>
                id
                <svg width="20" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="AudioItemRow__row__name cursor_pointer" onClick={() => {
                changeSort(7)
            }}>
                Название
                <svg width="20" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="AudioItemRow__row__type cursor_pointer" onClick={() => {
                changeSort(9)
            }}>
                Тип
                <svg width="20" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="AudioItemRow__row__fimbo_name cursor_pointer" onClick={() => {
                changeSort(11)
            }}>
                Связный Фимбо
                <svg width="20" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="AudioItemRow__row__fimbo_size cursor_pointer" onClick={() => {
                changeSort(13)
            }}>
                Размер Фимбо
                <svg width="20" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="AudioItemRow__row__path cursor_pointer" onClick={() => {
                changeSort(15)
            }}>
                Путь
                <svg width="20" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
