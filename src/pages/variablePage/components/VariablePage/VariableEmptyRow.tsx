...
const VariableEmptyRow = memo(() => {
    ...
    return (
        <div className="VariableItemRow__row" style={{padding: "10px"}}>
            <div className="VariableItemRow__row__id cursor_pointer" onClick={() => {
                changeSort(1)
            }}>
                id
            ...
            <div className="VariableItemRow__row__name cursor_pointer" onClick={() => {
                changeSort(3)
            }}>
                Название
                <svg width="20" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="VariableItemRow__row__description">
                Значение
            </div>
            <div className="VariableItemRow__row__description">
                Описание
            ...
            <div className="VariableItemRow__row__edit">
            </div>
        </div>
    );
})

export default VariableEmptyRow;