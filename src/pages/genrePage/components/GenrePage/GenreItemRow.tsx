...
import "./GenreItemRow.scss"
import {Link} from "react-router-dom";
import {Genre} from "../../../../models/Models";

interface IGenreItemRow {
    genre: Genre
    index: number
}

const GenreItemRow: FC<IGenreItemRow> = ({genre, index}) => {
    return (
        <>
            <div className={index % 2 === 1 ? "GenreItemRow__row" : "GenreItemRow__row GenreItemRow__row__color"}>
                ...
                <div className="GenreItemRow__row__edit">
                    <Link to={'/genre/' + genre.id}>
                        <svg className="GenreItemRow__row__edit__pen" xmlns="http://www.w3.org/2000/svg"
