...
import "./LessonTypeItemRow.scss"
import {LessonType} from "../../../../models/Models";
import {Link} from "react-router-dom";

interface ILessonTypeItemRow {
    lessonType: LessonType
    index: number
}

const LessonTypeItemRow: FC<ILessonTypeItemRow> = memo(({lessonType, index}) => {
    return (
        <div
            className={index % 2 === 1 ? "LessonTypeItemRow__row" : "LessonTypeItemRow__row LessonTypeItemRow__row__color"}
            style={lessonType.visible ? {} : {background: "none", color: "#606060"}}>

            <div className="LessonTypeItemRow__row__visible">
                {lessonType.visible ?
            ...
            <div className="LessonTypeItemRow__row__id">
                {lessonType.id}
            </div>

            <div className="LessonTypeItemRow__row__name">
                {lessonType.name}
            </div>
            <div className="LessonTypeItemRow__row__path">
                {lessonType.path}
            </div>

            <div className="LessonTypeItemRow__row__edit">
                <Link to={'/lesson-type/' + lessonType.id}>
                    <svg className="LessonTypeItemRow__row__edit__pen" xmlns="http://www.w3.org/2000/svg"
...
export default LessonTypeItemRow;